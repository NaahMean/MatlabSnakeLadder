    ...
    while game
        ...
        for i= 1:num_players
            ...
            if player(i).taketurn && player(i).position < numel(board)
                ...
                while (board(player(i).position).action ~= -1) && (board(player(i).position).action ~= 0) &&(board(player(i).position).action ~= 100)&& player(i).taketurn
